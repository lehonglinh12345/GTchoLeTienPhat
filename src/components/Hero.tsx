...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="grid grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            >
              BIẾN Ý TƯỞNG <br />
              <span className="inline-block px-2 py-1 text-transparent bg-clip-text bg-gradient-to-r from-studio-red to-studio-wine italic font-serif">THÀNH CÂU CHUYỆN</span><br />
              THỊ GIÁC
            </motion.h1>
            <motion.p 
              variants={{
            ...
            >
              Một studio sáng tạo chuyên về hoạt hình 3D, đồ họa chuyển động và kể chuyện bằng hình ảnh bằng cả trái tim.
            </motion.p>
          ...
          {/* New Video Demo Section on the Right */}
          <motion.div
          ...
          >
            <div className="relative group cursor-pointer">
              ...
              <div className="relative aspect-video sm:aspect-[4/5] rounded-[1.5rem] md:rounded-[2rem] overflow-hidden border border-white/20 xl:border-white/10 bg-studio-black shadow-2xl">
                <video 
                  ref={videoRef}
                  src="/trailer.mp4" 
                  autoPlay 
                ...
                <div className="absolute bottom-4 md:bottom-8 left-4 md:left-8 right-4 md:right-8">
                  <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
                    ...
                    <span className="text-[7px] md:text-[10px] text-white/70 md:text-white/50 uppercase font-bold tracking-widest">Dự án chuyên sâu</span>
                  </div>
                  <h3 className="text-[10px] md:text-xl font-bold text-white uppercase tracking-tighter">PHÒNG THỬ NGHIỆM 3D</h3>
                </div>
              </div>
      ...
      >
        <span className="text-white/30 text-[10px] uppercase tracking-[0.4em] font-medium">Cuộn xuống</span>
