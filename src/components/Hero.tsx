      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="grid grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            >
              Một studio sáng tạo chuyên về hoạt hình 3D, đồ họa
              chuyển động và kể chuyện bằng hình ảnh bằng cả trái tim.
            </motion.p>
            ...
            <div className="relative group cursor-pointer">
              ...
              <div
                ...
                className={`relative aspect-video sm:aspect-[4/5] rounded-[1.5rem] md:rounded-[2rem] overflow-hidden border border-white/20 xl:border-white/10 bg-studio-black shadow-2xl ${
                  isFullscreen
                    ? 'fixed inset-0 z-[9999] rounded-none aspect-auto'
                    : ''
                }`}
              >
                <video
                ...
                >
                  {isFullscreen ? (
                    <Minimize2 className="w-3.5 h-3.5 md:w-5 md:h-5" />
                  ) : (
                ...
                <div className="absolute bottom-4 md:bottom-8 left-4 md:left-8 right-4 md:right-8">
                  <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-2">
                    ...
                    <span className="text-[7px] md:text-[10px] text-white/70 md:text-white/50 uppercase font-bold tracking-widest">
                      Dự án chuyên sâu
                    </span>
                  </div>
